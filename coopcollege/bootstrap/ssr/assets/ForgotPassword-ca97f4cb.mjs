...
import { _ as _sfc_main$4 } from "./InputError-8978c575.mjs";
import { _ as _sfc_main$2 } from "./InputLabel-cd393c3d.mjs";
import { _ as _sfc_main$5 } from "./PrimaryButton-4cb8de39.mjs";
import { _ as _sfc_main$3 } from "./TextInput-f98eb51f.mjs";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<form class="py-28"${_scopeId}><div${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$5, {
              class: ["items-center justify-center h-14 bg-theme1 text-theme2 text-sm hover:bg-theme2 hover:text-theme1", { "opacity-25": unref(form).processing }],
