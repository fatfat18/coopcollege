...
const _imports_0 = "/build/assets/lpg1-d301e54a.jpg";
const navigation = "";
const pagination = "";
const img1 = "/build/assets/landingpage-e281d26c.jpg";
const img2 = "/build/assets/landingpagenew-2e9bfc32.jpg";
const img3 = "/build/assets/landingpagenewest-edfebef8.jpg";
...
const __default__ = {
  ...
  methods: {
    prevSlide() {
      this.currentIndex = (this.currentIndex - 1 + this.cover.length) % this.cover.length;
    },
    nextSlide() {
