...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><p class="text-white text-xl" data-aos="fade-down" data-aos-duration="400" data-aos-delay="500"> Message us Now! </p><div class="flex justify-center items-center space-x-2 py-4 px-2" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="500"><div class="bg-white py-2 px-4 rounded-xl transition ease-in duration-150 hover:scale-125"><a${ssrRenderAttr("href", _ctx.fb)} target="_blank">`);
      _push(ssrRenderComponent(unref(FontAwesomeIcon), {
        icon: "fa-brands fa-facebook",
        class: "text-theme1 overflow-y-hidden"
      }, null, _parent));
      _push(`</a></div><a${ssrRenderAttr("href", _ctx.email)} target="_blank"><div class="bg-white py-2 px-4 rounded-xl transition ease-in duration-150 hover:scale-125">`);
      _push(ssrRenderComponent(unref(FontAwesomeIcon), {
