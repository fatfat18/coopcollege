                          ...
                          return [
                            createVNode("h2", { class: "text-black text-l" }, [
                              ...
                              createVNode("span", { class: "text-theme1" }, [
                                createTextVNode(toDisplayString(_ctx.confirmdate) + " " + toDisplayString(_ctx.confirmyear) + " ", 1),
                                createVNode("span", { class: "text-black" }, "at"),
                                createTextVNode(" " + toDisplayString(_ctx.confirmvenue), 1)
                              ]),
                              createTextVNode("? ")
                            ]),
                            createVNode("br"),
