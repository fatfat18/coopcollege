      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<form${_scopeId}><div class=""${_scopeId}><div class="text-sm w-full text-center mb-1 text-zinc-500"${_scopeId}> Login to continue </div><div class="flex justify-center items-center"${_scopeId}><div class="form-control"${_scopeId}><input class="" type="text" required autofocus${ssrRenderAttr("value", unref(form).email)}${_scopeId}><label${_scopeId}><i class="text-theme2 text-xl pr-4"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "" }, [
                  createVNode("div", { class: "text-sm w-full text-center mb-1 text-zinc-500" }, " Login to continue "),
