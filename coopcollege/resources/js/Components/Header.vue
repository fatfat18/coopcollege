...
<div id="welcome" class="xl:h-60 h-28 bg-theme1 w-screen text-white  md:text-sm flex xl:flex-row justify-center items-center py-20 overflow-y-hidden welcome ">
    ...
    <div class=" flex xl:justify-center xl:items-center md:items-start md:justify-center  ">
        <a href="/"><img src="../../asset/logo.png" class="mx-2 xl:h-32 h-20 xl:mr-8 md:mr-4 min-w-fit shadow-2xl" data-aos="fade-right" data-aos-delay="300"  data-aos-duration="800" /></a> <p class="pt-2 overflow-y-hidden xl:text-3xl tracking-wider pl-2 xl:pl-0 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)]" data-aos="fade-right" data-aos-delay="100" data-aos-duration="500">CO-OPERATIVE COLLEGE <br><span class="xl:text-xl text-xxs absolute">OF THE</span><span class="mx-6 xl:mx-10"></span>PHILIPPINES</p>
    </div>
