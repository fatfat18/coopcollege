...
<template>
    ...
    <div class="min-h-screen flex xl:flex-row flex-col sm:justify-center items-center xl:pt-6 sm:pt-0 bg-gray-100 justify-center postcontainer" >
        ...
        <div
            class="logtest rounded-md w-full z-50 sm:max-w-md px-6 xl:py-32 py-20  xl:flex flex-col xl:justify-center xl:items-center bg-zinc-50 shadow-2xl overflow-hidden" data-aos="fade-right" data-aos-duration="1000"
        >
