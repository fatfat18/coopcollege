...
<div class="w-screen h-max bg-zinc-200  flex justify-center items-center ">
    ...
    <div class="h-max max-w-7xl w-screen  flex xl:flex-row flex-col">
            ...
            <div class="h-max xl:w-1/2  flex-col min-h-max flex justify-center items-center "  >
                ...
                <img :src="this.img" alt="" :key="img" id="dispimg" @click="showimgmod()"  class="card rounded-md cursor-pointer transition duration-1000 w-max xl:h-96 object-cover my-10  " data-aos="fade"  data-aos-duration="1000" >
            ...
            <div class="h-max xl:w-1/2  flex flex-col text-center  pt-10 px-10">
                ...
                <h1 class="text-3xl text-theme1 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)]" data-aos="zoom-out" data-aos-duration="1000"> {{ title }}</h1><br>
                <h1 class="text-xl text-theme2 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)] " data-aos="zoom-out" data-aos-duration="1000"> {{ description }}</h1><br>
