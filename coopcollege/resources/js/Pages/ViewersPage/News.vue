...
<div class=" h-max bg-white justify-center items-center w-screen flex xl:py-10 xl:px-20 flex-wrap">

    <div v-for="(post, index) in paginatedPosts" :key="post.Postid" class="overflow-y-hidden flex items-center justify-center xl:px-15  ">
     <NewsCol 
