...
<template>
    <AuthenticatedLayout>
        ...
        <div class="py-8 postcontainer overflow-y-hidden h-max min-h-screen">
            ...
            >
                <div
                    class="max-w-7xl bg-white xl:px-8 xl:py-4 py-4 rounded-sm grid grid-cols-9 gap-4 xl:text-xs text-[10px] xl:text-md"
                >
                    <div
                    ...
                    <div
                        class="flex justify-center text-center items-center col-span-3"
                    >
                        CONTEXT
                    </div>
                    <div
                ...
                <template v-for="(item, index) in items" :key="item.Postid">
                    ...
                    >
                        ...
                        >
                            <button
                                button
                                @click="navigateToUpdate(item.Postid)"
...
export default {
    ...
    methods: {
        ...
        navigatetoDelete() {
            ...
            axios
                .delete(BASE_URL + "/deleteCategory" + "?" + params.toString())
                .then((response) => {
