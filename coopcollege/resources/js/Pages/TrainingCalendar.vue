...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <template #header> 
            <h2 class="font-bold text-3xl leading-tight text-theme1 ">Manage Training Calendar</h2>
        </template>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 overflow-y-hidden space-y-1 h-max" data-aos="fade-up" data-aos-duration="1000">
        ...
        <template v-for="(item, index) in reversedItems" :key="item.idTC">
              ...
              <div class=" flex justify-center text-center items-center">
                ...
                <button @click="navigateToUpdate(item.idTC)" class="py-2 xl:px-8 px-4  rounded-full bg-blue-400 xl:rounded-lg text-white text-[11px] xl:text-md transition duration-300 hover:text-blue-400 hover:bg-white border-2 border-blue-400">Edit</button>
              
              </div>
              <div class=" flex justify-center text-center items-center ">
                          <button @click.prevent="confirmdel(item)"  class="py-2 xl:px-8 px-4  rounded-full bg-red-500 xl:rounded-lg text-white text-[11px] xl:text-md transition duration-300 hover:text-red-500 hover:bg-white border-2 border-red-500">Delete</button>
              </div>
