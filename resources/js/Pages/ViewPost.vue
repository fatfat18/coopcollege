...
<template>
    ...
    <div
        class="w-screen h-max bg-gradient-to-b from-theme2 to-white flex justify-center items-center pt-40"
    >
        <div class="h-max max-w-7xl w-screen flex xl:flex-row flex-col">
            <div
                class="h-max xl:w-1/2 flex-col min-h-max flex justify-center items-center"
            >
                <img
                    :src="img"
                    alt=""
                    ...
                    id="dispimg"
                    @click="showimgmod()"
                    class="card rounded-md cursor-pointer transition duration-1000 w-max xl:h-96 object-cover my-10"
                    data-aos="fade"
                ...
                >
                    <div
                        v-for="imageUrl in imagePreviewUrlholder"
                        :key="imageUrl"
                    >
                        <img
                            @click="changeImage(imageUrl)"
                            :src="imageUrl"
                            class="card rounded-md transition duration-300 hover:scale-110 clickable-div h-32 w-40 object-cover my-5 mx-5"
                        />
                    </div>
                </div>
            </div>
            ...
            <div
                class="h-max xl:w-1/2 flex flex-col text-center pt-10 xl:px-10 px-4"
            >
                <h1
                ...
                <br />
                <h1
                    class="xl:text-2xl text-xl text-white"
                    data-aos="zoom-out"
                    data-aos-duration="1000"
                >
                    {{ description }}
                ...
                <p
                    class="text-black text-sm xl:text-base flex items-center justify-center text-center xl:text-start"
                    data-aos="zoom-out"
                    data-aos-duration="1000"
                >
                    {{ context }}
                ...
                <div
                    class="mt-10 w-full overflow-y-hidden h-full flex justify-center items-center"
                >
                    <img
                        src="../../asset/logo.png"
                        alt=""
        ...
        axios
            ...
            .then((response) => {
                ...
                for (let i = 0; i < this.items.image.length; i++) {
                    this.imagePreviewUrlholder[i] =
                        this.items.image[i].ImageUrl;
                }
