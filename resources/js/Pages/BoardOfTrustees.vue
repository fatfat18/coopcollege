...
<template>
    <AuthenticatedLayout>
        ...
        <div class="py-8 postcontainer overflow-y-hidden h-max min-h-screen">
            ...
            >
                <div
                    class="max-w-7xl bg-white xl:px-8 xl:py-4 py-4 rounded-sm grid grid-cols-6 text-xs xl:text-md"
                >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <button
                                button
                                @click="navigateToUpdate(item.idBOD)"
