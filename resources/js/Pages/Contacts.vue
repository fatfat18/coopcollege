        ...
        <div class="py-8 postcontainer overflow-y-hidden h-max min-h-screen">
            ...
            >
                <form @submit.prevent="updateContactUs">
                    ...
                    >
                        <button
                            @click="updateContactUs(item.idcontactUs)"
...
export default {
    ...
    methods: {
        updateContactUs() {
            ...
            let item = this.contactUs.find(
                (item) => item.idcontactUs === this.idcontactUs
            );
            ...
            axios
                ...
                .then((response) => {
                    ...
                    async function redirectWithDelay() {
                        ...
                        window.location.href = route("Contacts"); // redirect to the TrainingCalendar URL
                    }
                    redirectWithDelay();
                })
                .catch((error) => {
