...
import "axios";
const PostsUpdate_vue_vue_type_style_index_0_lang = "";
const __default__ = {
  data() {
    return {
      imagePreviewUrl: [],
  ...
  mounted(event) {
    axios.get(BASE_URL + "/displayPost").then((response) => {
      ...
      axios.get(BASE_URL + "/postCategory").then((response2) => {
  ...
  methods: {
    ...
    updatePosts() {
      ...
      axios.put(BASE_URL + "/updateCategory?" + params.toString()).then((response) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              "onUpdate:modelValue": ($event) => this.title = $event,
              "data-aos": "fade-up",
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              "onUpdate:modelValue": ($event) => this.description = $event,
              "data-aos": "fade-up",
              "data-aos-duration": "1000"
            }, null, _parent2, _scopeId));
            _push2(`<textarea id="context" name="context" type="text" class="mt-2 h-72 py-2 px-2 block w-full rounded-lg focus:ring-yellow-500 active:ring-yellow-500" required autocomplete="current-Context" placeholder="Context" data-aos="fade-up" data-aos-duration="1000"${_scopeId}>${ssrInterpolate(this.context)}</textarea><select class="mt-4" name="posttype"${_scopeId}><option hidden${_scopeId}>Post Type</option><!--[-->`);
            ssrRenderList(_ctx.category, (item) => {
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h2 class="text-theme1 text-2xl"${_scopeId2}>Update Post</h2><p class="text-theme2 text-4xl mb-5"${_scopeId2}>Success!</p>`);
                } else {
                  return [
                    createVNode("h2", { class: "text-theme1 text-2xl" }, "Update Post"),
            ...
            return [
              ...
              createVNode("div", { class: "postcontainer flex justify-center h-max w-screen xl:px-10 xl:pb-96 py-20 overflow-y-hidden" }, [
                createVNode("div", { class: "xl:w-3/4 w-4/5 h-max xl:mt-4" }, [
                  createVNode("form", {
                    onSubmit: withModifiers(($event) => _ctx.updatePosts(this.intNum), ["prevent"])
                  }, [
                    ...
                    createVNode("div", { class: "overflow-y-hidden" }, [
                      ...
                      withDirectives(createVNode("textarea", {
                        ...
                        placeholder: "Context",
                        "onUpdate:modelValue": ($event) => this.context = $event,
                        "data-aos": "fade-up",
                        "data-aos-duration": "1000"
                      }, "\n                            \n                                ", 8, ["onUpdate:modelValue"]), [
                        [vModelText, this.context]
                      ]),
                      withDirectives(createVNode("select", {
                        class: "mt-4",
                        "onUpdate:modelValue": ($event) => this.posttype = $event,
                        name: "posttype"
                      }, [
                        createVNode("option", { hidden: "" }, "Post Type"),
                        (openBlock(true), createBlock(Fragment, null, renderList(_ctx.category, (item) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Editor/PostsUpdate.vue");
