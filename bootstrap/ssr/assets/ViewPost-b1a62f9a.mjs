...
import AOS from "aos";
import "../app.mjs";
import { _ as _sfc_main$2, a as _sfc_main$3 } from "./Header-4516f300.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", this.img)} alt="" id="dispimg" class="transition duration-300 w-max xl:w-full test scale-125 object-contain my-10" data-aos="fade-down" data-aos-duration="1000"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: this.img,
