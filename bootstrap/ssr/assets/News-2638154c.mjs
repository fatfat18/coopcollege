...
import AOS from "aos";
import "../app.mjs";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./Header-4516f300.mjs";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.mjs";
import { _ as _sfc_main$5 } from "./Footer-728a5db0.mjs";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "z-1 header w-full overflow-y-hidden h-full justify-center items-center xl:h-screen bg-white flex text-theme1 flex-col-reverse xl:flex-row" }, _attrs))}><div class="z-10 w-3/4 xl:mx-20 mb-10 xl:mb-0 overflow-y-hidden xl:py-24 pt-10 xl:rounded-lg px-10 xl:px-0 h-full xl:h-full flex flex-col justify-center items-center"><p class="xl:text-3xl text-l text-center" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="700">${ssrInterpolate($props.title)}</p><p class="xl:text-l text-base xl:mb-10 mb-0 text-theme2 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)]" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="800">${ssrInterpolate($props.description)}</p><p class="xl:px-10 text-justify xl:text-md text-sm my-10" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="1000">${ssrInterpolate($props.context)}</p></div><div class="overflow-y-hidden w-screen xl:h-full h-max py-20 flex justify-center items-center xl:mr-20" data-aos="zoom-out" data-aos-duration="1000" data-aos-delay="500"><img${ssrRenderAttr("src", $props.image)} alt="image" class="xl:w-screen rounded-lg hover:scale-110 transition duration-500"></div></div>`);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(NewsHeading, {
        ...
        onClick: ($event) => _ctx.navigateToPost(this.pid)
      }, null, _parent));
