...
import { _ as _sfc_main$6 } from "./InputError-8978c575.mjs";
import { _ as _sfc_main$4 } from "./InputLabel-cd393c3d.mjs";
import { _ as _sfc_main$3 } from "./Modal-7cee2fea.mjs";
import { _ as _sfc_main$5 } from "./TextInput-f98eb51f.mjs";
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        type: __props.type,
        class: "inline-flex items-center px-4 py-2 bg-red-300 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150"
      }, _attrs))}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              class: ["ml-3 hover:bg-red-900", { "opacity-25": unref(form).processing }],
