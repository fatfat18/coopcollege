...
const __default__ = {
  ...
  methods: {
    ...
    updatePartners() {
      ...
      axios.put(BASE_URL + "/updatePartnerStatus?" + params.toString()).then((response) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              "onUpdate:modelValue": ($event) => this.name = $event,
              "data-aos": "fade-up",
            ...
            return [
              ...
              createVNode("div", { class: "postcontainer flex justify-center w-screen xl:px-10 xl:pb-96 pt-20" }, [
